...
[source,html]
----
include::examples/javascript/javascriptDOM.html[]
----

[[javascripthtml_meta]]
=== Reading META Tags via JavaScript</title>
...
[source,html]
----
include::examples/javascript/meta.html[]
----
...
[source,html]
----
include::examples/forms/feedback.js[]
----

[source,html]
----
include::examples/forms/feedback.html[]
----
