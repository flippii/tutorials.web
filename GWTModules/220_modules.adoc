...
them into the
package "client" in your GWT project. 
This is bad
...
GWT needs to have access to the source files to compile them into Javascript code. 
If you add the project or the jar file to your
...
Create a Java project "de.vogella.gwt.module.model" and package "de.vogella.gwt.module.model". 
...
Create in package "de.vogella.gwt.module" the file "model.gwt.xml" with the following content.
...
TIP:  If you make a typo here you will get an error message: [ERROR] Unable to find 'de/vogella/gwt/module/model2.gwt.xml' on your classpath;
