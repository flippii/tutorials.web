...
:docinfodir: ../
:vgwort: GoogleCloudMessaging

[abstract]
Android C2DMs.
This tutorial describes how to push information from a server to the Google device. 
It is based on Eclipse 3.7, Java 1.6 and Android 2.3 (Gingerbread). 
...
include::040_device.adoc[]
include::060_app.adoc[]
include::120_curl.adoc[]
include::../web/advertisement/inBetween02.adoc[]
include::140_serverapp.adoc[]
